...
if(is_file(base_app.'pages/about.html')){
  $content = file_get_contents(base_app.'pages/about.html');
}
?>
  ...
  <div class="card-body rounded-0 pt-4">
    <div class="container-fluid">
      <form action="" id="page-form">
        <textarea name="page[about]" id="" cols="30" rows="10" class="form-control tinymce-editor" requried=""><?= $content ?? "" ?></textarea>
      </form>
    </div>
  </div>
